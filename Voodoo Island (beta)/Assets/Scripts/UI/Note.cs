    ...
    void OnTriggerStay2D(Collider2D other)
    {
        ...
        if (other.tag == "Player")
        {
            ...
            if (Input.GetKey(KeyCode.E))
            {
                ...
                {
                    textObject.text = "The needle of man threads in and out of other's lives.\n You should not have returned to mine.\n[What a nutjob.]";
                    header.text = "Strange Message";
                } else if (objname == "ButlerMap")
                {
                    textObject.text = "[someone has scribbled all over a map of the complex, rendering it basically useless. \n It appears to be the butler's escape plan - but unfortunately you don't think anyone made it off the island.]";
